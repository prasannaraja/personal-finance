        ...
        _createClass(CurrentComponent, [{
          ...
          value: function loadExpenseTable() {
            ...
            this.apiService.getExpense().subscribe(function (expenses) {
              ...
              _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](expenses.data);
          ...
          value: function deleteExpense(expenseId) {
            ...
            dialogRef.afterClosed().subscribe(function (dialogResult) {
              ...
              if (dialogResult) {
                _this2.apiService.deleteExpense(expenseId).subscribe(function (res) {
                  _this2._snackBar.openFromComponent(ExpenseDeletedSnackBarComponent, {
                    duration: 3000
                  });

                  _this2.loadExpenseTable();
                }, function (error) {
                  console.log("error:");
                  console.log(error);
